import type { IntegerFieldConfig } from "@/types/template";
...
/**
 * Integer input field component for report data entry.
 * Renders a numeric input accepting only whole numbers with step_size,
