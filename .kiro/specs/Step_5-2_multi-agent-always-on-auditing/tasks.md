...
- [ ] 1. Database models and Pydantic schemas
  - [-] 1.1 Create review pipeline database models
  ...
  - [-] 1.2 Create audit profile database model
  ...
  - [-] 1.3 Create anomaly alert database model
  ...
  - [~] 1.4 Create Alembic migration for all new models
  ...
  - [-] 1.5 Create Pydantic schemas for review API
  ...
  - [~] 1.6 Register new models in models/__init__.py
...
- [ ] 2. Audit Profile Service
  - [~] 2.1 Implement AuditProfileService
  ...
  - [~] 2.2 Write property test for quorum constraint (Property 6)
  ...
  - [~] 2.3 Write property test for default profile uniqueness (Property 10)
...
- [ ] 3. Compliance Score and Core Pipeline Logic
  - [~] 3.1 Implement compliance score computation
  ...
  - [~] 3.2 Write property test for compliance score (Property 1)
  ...
  - [~] 3.3 Implement consensus and contradiction detection logic
  ...
  - [~] 3.4 Write property test for consensus detection (Property 3)
...
- [ ] 5. Review Pipeline Service
  - [~] 5.1 Implement ReviewPipelineService core
  ...
  - [~] 5.2 Implement Celery review tasks
  ...
  - [~] 5.3 Write property test for quorum enforcement (Property 2)
  ...
  - [~] 5.4 Write property test for state machine validity (Property 8)
  ...
  - [~] 5.5 Write property test for action item transitions (Property 9)
...
- [ ] 6. Master Auditor Archetype
  - [~] 6.1 Create Master Auditor archetype YAML
...
- [ ] 7. Missing Link Detection
  - [~] 7.1 Implement MissingLinkService
  ...
  - [~] 7.2 Write property test for missing link classification (Property 4)
...
- [ ] 8. Anomaly Detection
  - [~] 8.1 Implement AnomalyDetectionService
  ...
  - [~] 8.2 Implement anomaly detection periodic Celery task
  ...
  - [~] 8.3 Write property test for anomaly deduplication (Property 5)
...
- [ ] 10. FastAPI endpoints
  ...
  - [~] 10.2 Implement audit profiles router
  ...
  - [~] 10.3 Implement compliance router
  ...
  - [~] 10.4 Register new routers in router.py
    - Add reviews, audit_profiles, and compliance routers to the central router
    - _Requirements: 10.1–10.8_

  - [~] 10.5 Write property test for company-scoped isolation (Property 7)
  ...
  - [~] 10.6 Write unit tests for API endpoints
...
- [ ] 12. Frontend — Review Dashboard
  - [~] 12.1 Create frontend API client functions and TypeScript types
  ...
  - [~] 12.2 Create Zustand store for review state
  ...
  - [~] 12.3 Implement ReviewDashboardPage with session list
  ...
  - [~] 12.4 Implement ReviewSessionDetail component
  ...
  - [~] 12.5 Implement AgentReportComparison component
  ...
  - [~] 12.6 Implement SeverityHeatmap component
  ...
  - [~] 12.7 Implement ActionItemTracker component
  ...
  - [~] 12.8 Implement ComplianceScorecard component
  ...
  - [~] 12.9 Implement "Submit for Review" modal on document detail
  ...
  - [~] 12.10 Add route and navigation for ReviewDashboardPage
