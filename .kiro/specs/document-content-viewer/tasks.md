...
- [x] 1. Database migration and content type utilities
  - [x] 1.1 Create Alembic migration to add `content_type` column to `document_versions`
  ...
  - [x] 1.2 Create `services/content_type_utils.py` with pure utility functions
  ...
  - [x] 1.3 Write property tests for content type utilities (Property 4: Content-Type Resolution)
  ...
  - [x] 1.4 Write property tests for disposition classification (Property 2: Content-Type Disposition Classification)
  ...
  - [x] 1.5 Write property tests for response header construction (Property 1: Response Header Correctness)
...
- [x] 2. Backend audit access logger
  - [x] 2.1 Extend `services/audit_access_logger.py` with document access logging
...
- [x] 3. Backend download and content endpoints
  - [x] 3.1 Implement download endpoint in `api/documents.py`
  ...
  - [x] 3.2 Implement content preview endpoint in `api/documents.py`
  ...
  - [x] 3.3 Write unit tests for download and content endpoints
  ...
  - [x] 3.4 Write property test for RBAC enforcement consistency (Property 3: RBAC Enforcement Consistency)
...
- [x] 5. Frontend API client and download utility
  - [x] 5.1 Add `download` method to `lib/apiClient.ts`
  ...
  - [x] 5.2 Create `lib/fileDownload.ts` utility
  ...
  - [x] 5.3 Write unit tests for apiClient.download and fileDownload
...
- [x] 6. Frontend ContentViewer component
  - [x] 6.1 Create `components/documents/ContentViewer.tsx`
  ...
  - [x] 6.2 Write unit tests for ContentViewer
  ...
  - [x] 6.3 Write property test for latest version resolution (Property 5: Latest Version Resolution)
  ...
  - [x] 6.4 Write property test for markdown rendering (Property 6: Markdown Rendering Produces Valid HTML Structure)
...
- [x] 7. Frontend DownloadButton component
  - [x] 7.1 Create `components/documents/DownloadButton.tsx`
  ...
  - [x] 7.2 Write unit tests for DownloadButton
...
- [x] 8. Integration into existing pages
  - [x] 8.1 Integrate ContentViewer and DownloadButton into DocumentDetail page
  ...
  - [x] 8.4 Write integration tests for DocumentDetail with ContentViewer
