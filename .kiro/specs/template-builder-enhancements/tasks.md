...
- [x] 1. Backend: Database models and Alembic migration
  - [x] 1.1 Create TemplateVersion and TemplateVersionField SQLAlchemy models
  ...
  - [x] 1.2 Create Alembic migration for new tables and columns
...
- [x] 2. Backend: Enhanced Pydantic schemas
  - [x] 2.1 Create field configuration schemas
  ...
  - [x] 2.2 Create enhanced template schema and version schemas
...
- [x] 3. Backend: TemplateService enhancements
  - [x] 3.1 Implement enhanced template creation with elements
  ...
  - [x] 3.2 Implement version creation with race condition protection
  ...
  - [x] 3.3 Implement version history and retrieval methods
...
- [x] 4. Backend: API endpoints for versioning and enhanced PDF download
  - [x] 4.1 Add version CRUD endpoints to template router
  ...
  - [x] 4.2 Enhance PDF download endpoint for version-awareness
...
- [x] 5. Backend: PDFGenerator enhancements
  - [x] 5.1 Add content block rendering to PDFGenerator
  ...
  - [x] 5.2 Add rich field configuration rendering to PDFGenerator
  ...
  - [x] 5.3 Add version number rendering and hidden version field
...
- [x] 7. Frontend: Enhanced TypeScript types
  - [x] 7.1 Create enhanced type definitions
...
- [x] 8. Frontend: Enhanced templateBuilderStore
  - [x] 8.1 Refactor store to use CanvasItem union type
  ...
  - [x] 8.2 Add field configuration update actions
  ...
  - [x] 8.3 Add content block configuration actions
  ...
  - [x] 8.4 Update serialization and canSave logic
  ...
  - [x] 8.5 Add versioning actions to store
  ...
  - [x] 8.6 Add PDF download action to store
...
- [x] 9. Frontend: Type-specific configuration panels
  - [x] 9.1 Create TextConfigPanel component
  ...
  - [x] 9.2 Create FloatConfigPanel component
  ...
  - [x] 9.3 Create IntegerConfigPanel component
  ...
  - [x] 9.4 Create DateConfigPanel component
  ...
  - [x] 9.5 Create BooleanConfigPanel component
...
- [x] 10. Frontend: Content block components
  - [x] 10.1 Create CanvasContentBlock component
  ...
  - [x] 10.2 Create ContentBlockConfigPanel component
...
- [x] 11. Frontend: Enhanced ConfigurationPanel
  - [x] 11.1 Refactor ConfigurationPanel with common properties and type routing
...
- [x] 12. Frontend: Enhanced FieldPalette with Content section
  - [x] 12.1 Add Content section to FieldPalette
...
- [x] 13. Frontend: Enhanced BuilderCanvas for mixed items
  - [x] 13.1 Update BuilderCanvas to render CanvasItem union
...
- [x] 14. Checkpoint — Frontend builder core tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 15. Frontend: VersionHistoryPanel
  - [x] 15.1 Create VersionHistoryPanel component
...
- [x] 16. Frontend: ChangeReasonDialog
  - [x] 16.1 Create ChangeReasonDialog modal component
...
- [x] 17. Frontend: PdfPreviewPanel
  - [x] 17.1 Create PdfPreviewPanel component
...
- [x] 18. Frontend: DownloadPdfButton and PDF download integration
  - [x] 18.1 Create DownloadPdfButton component
...
- [x] 19. Frontend: Template detail page and routing
  - [x] 19.1 Create template detail page with version-aware layout
  ...
  - [x] 19.2 Update template list view with version information
...
- [x] 20. Checkpoint — Full integration tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 21. Property-based tests (frontend)
  - [x] 21.1 Write property test for serialization round-trip
  ...
  - [x] 21.2 Write property test for cross-field min/max constraint validation
  ...
  - [x] 21.3 Write property test for default value type validation
  ...
  - [x] 21.4 Write property test for regex pattern validity
  ...
  - [x] 21.5 Write property test for field order contiguous invariant
  ...
  - [x] 21.6 Write property test for canSave reflects validation state
  ...
  - [x] 21.7 Write property test for preview completeness
...
- [x] 22. Property-based tests (backend)
  - [x] 22.1 Write property test for version creation invariant
  ...
  - [x] 22.2 Write property test for version immutability
  ...
  - [x] 22.3 Write property test for PDF filename version format
...
- [x] 23. Unit and integration tests
  - [x] 23.1 Write unit tests for type-specific config panels
  ...
  - [x] 23.2 Write unit tests for CanvasContentBlock and ContentBlockConfigPanel
  ...
  - [x] 23.3 Write unit tests for VersionHistoryPanel and DownloadPdfButton
  ...
  - [x] 23.4 Write backend unit tests for enhanced TemplateService
  ...
  - [x] 23.5 Write backend unit tests for enhanced PDFGenerator
  ...
  - [x] 23.6 Write backend integration tests for versioning API
