...
- [ ] 1. Database models, schemas, and migration
  - [ ] 1.1 Create SQLAlchemy models for system configuration
  ...
  - [ ] 1.2 Create Pydantic schemas for system configuration
  ...
  - [ ] 1.3 Create Alembic migration for system configuration tables
...
- [ ] 2. Core service: SystemConfigurationService
  - [ ] 2.1 Implement SystemConfigurationService
  ...
  - [ ]* 2.2 Write property test for X-Change-Reason header validation
  ...
  - [ ]* 2.3 Write property test for configuration value range validation
  ...
  - [ ]* 2.4 Write property test for inference mode enum validation
  ...
  - [ ]* 2.5 Write property test for configuration diff computation
  ...
  - [ ]* 2.6 Write property test for configuration rollback round-trip
  ...
  - [ ]* 2.7 Write property test for atomic rollback on validation failure
  ...
  - [ ]* 2.8 Write unit tests for SystemConfigurationService
...
- [ ] 3. Core service: HealthMonitor
  - [ ] 3.1 Implement HealthMonitor service
  ...
  - [ ]* 3.2 Write property test for health status classification
  ...
  - [ ]* 3.3 Write property test for health check history bounded buffer
  ...
  - [ ]* 3.4 Write property test for health status transition detection
  ...
  - [ ]* 3.5 Write unit tests for HealthMonitor
...
- [ ] 4. Core service: BackupService
  - [ ] 4.1 Implement BackupService
  ...
  - [ ]* 4.2 Write property test for cron expression validation
  ...
  - [ ]* 4.3 Write property test for backup expiration logic
  ...
  - [ ]* 4.4 Write property test for minimum one backup retained
  ...
  - [ ]* 4.5 Write property test for no concurrent backup executions
  ...
  - [ ]* 4.6 Write unit tests for BackupService
...
- [ ] 5. Core service: StorageQuotaService
  - [ ] 5.1 Implement StorageQuotaService
  ...
  - [ ]* 5.2 Write property test for human-readable byte formatting
  ...
  - [ ]* 5.3 Write property test for quota status classification
  ...
  - [ ]* 5.4 Write unit tests for StorageQuotaService
...
- [ ] 6. Core service: ServiceRegistry
  - [ ] 6.1 Implement ServiceRegistry
  ...
  - [ ]* 6.2 Write property test for memory utilization warning threshold
  ...
  - [ ]* 6.3 Write unit tests for ServiceRegistry
...
- [ ] 8. Celery tasks for system configuration
  - [ ] 8.1 Implement Celery tasks for health checks, backups, and metrics
  ...
  - [ ]* 8.2 Write unit tests for Celery tasks
...
- [ ] 9. API router: system configuration endpoints
  - [ ] 9.1 Implement system_config API router (AI hardware + vLLM endpoints)
  ...
  - [ ] 9.2 Implement storage and quota endpoints
  ...
  - [ ] 9.3 Implement backup endpoints
    - Add to `src/backend/src/alcoabase/api/system_config.py`
  ...
  - [ ] 9.4 Implement health monitoring endpoints
    - Add to `src/backend/src/alcoabase/api/system_config.py`
  ...
  - [ ] 9.5 Implement service status and snapshot endpoints
    - Add to `src/backend/src/alcoabase/api/system_config.py`
  ...
  - [ ] 9.6 Register system_config router in central router
  ...
  - [ ]* 9.7 Write property test for RBAC permission enforcement on system config endpoints
...
- [ ] 11. Frontend: TypeScript types and Zustand store
  - [ ] 11.1 Create TypeScript types for system configuration
  ...
  - [ ] 11.2 Create Zustand store for system configuration
  ...
  - [ ]* 11.3 Write unit tests for useSystemConfigStore
...
- [ ] 12. Frontend: SystemConfigPage and AI Hardware tab
  - [ ] 12.1 Implement SystemConfigPage with tab layout
  ...
  - [ ] 12.2 Implement AI Hardware tab components
...
- [ ] 13. Frontend: Storage and Backups tabs
  - [ ] 13.1 Implement Storage tab components
  ...
  - [ ] 13.2 Implement Backups tab components
...
- [ ] 14. Frontend: Health and Services tabs
  - [ ] 14.1 Implement Health tab components
  ...
  - [ ] 14.2 Implement Services tab components
...
- [ ] 15. Frontend: History tab and rollback
  - [ ] 15.1 Implement History tab components
  ...
  - [ ]* 15.2 Write frontend property tests (fast-check)
...
- [ ] 16. Integration tests
  - [ ]* 16.1 Write backend integration tests for system configuration API
