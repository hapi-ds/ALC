...
- [ ] 1. Define schemas, constants, and configuration
  - [ ] 1.1 Create Pydantic schemas for SeedReport and related result models
  ...
  - [ ] 1.2 Create seed data constants module
  ...
  - [ ] 1.3 Add ALC_SEED_DEFAULT_PASSWORD to Settings in config.py
...
- [ ] 2. Implement slug reservation guard
  - [ ] 2.1 Add slug reservation validation
  ...
  - [ ]* 2.2 Write property test for slug reservation (Property 4)
...
- [ ] 3. Implement ALCSeedService core
  - [ ] 3.1 Create ALCSeedService class with execute() orchestrator
  ...
  - [ ] 3.2 Implement _create_company() step
  ...
  - [ ] 3.3 Implement _provision_users() step
  ...
  - [ ] 3.4 Implement _apply_regulatory_baseline() step
  ...
  - [ ] 3.5 Implement _create_folder_structure() step
  ...
  - [ ] 3.6 Implement _configure_risk_profile() step
  ...
  - [ ] 3.7 Implement _activate_agents() step
  ...
  - [ ] 3.8 Implement _create_governance_workflow() step
...
- [ ] 4. Checkpoint - Ensure core service logic is complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implement CLI script and API endpoint
  - [ ] 5.1 Create CLI script for seed execution
  ...
  - [ ] 5.2 Create API endpoint for seed execution
...
- [ ] 6. Write property-based tests
  - [ ]* 6.1 Write property test for idempotency (Property 1)
  ...
  - [ ]* 6.2 Write property test for transaction atomicity (Property 2)
  ...
  - [ ]* 6.3 Write property test for SeedReport accuracy (Property 3)
  ...
  - [ ]* 6.4 Write property test for password configuration (Property 5)
  ...
  - [ ]* 6.5 Write property test for agent activation completeness (Property 6)
...
- [ ] 7. Write unit tests
  - [ ]* 7.1 Write unit tests for company creation and user provisioning
  ...
  - [ ]* 7.2 Write unit tests for regulatory baseline, folders, and risk profile
  ...
  - [ ]* 7.3 Write unit tests for agent activation and workflow creation
...
- [ ] 8. Write integration tests
  - [ ]* 8.1 Write integration tests for CLI and API
